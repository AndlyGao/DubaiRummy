package com.gamegards.dubairummy._RummyDeal.Fragments;
...
import com.gamegards.dubairummy._RummyDeal.RummyDealGame;
import com.gamegards.dubairummy._RummyPull.RummyPullGame;
        ...
        try {
            ...
            if (code == 200)
            {
                ...
                for (int i = 0; i < tableArray.length() ; i++) {
                    ...
                    model.setTable_name(tableObject.optString("name","0"));
